...
void ProcessPacket(unsigned char *buffer, int size)
{
	...
	char src_addr_str[INET6_ADDRSTRLEN]; // INET6_ADDRSTRLEN is the maximum size of an IPv6 address string

	// Convert the source address to a string and print it
	if (inet_ntop(AF_INET6, &(ipv6_hdr->ip6_src), src_addr_str, INET6_ADDRSTRLEN) == NULL)
	{
		// handle error
	}
